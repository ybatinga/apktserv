...
public class CalcVarsService {
    public static final String FEE_ORDER_TAKER = "1.5";
    public static final String FEE_ORDER_MAKER = "1.5";
    ...
    public static final BigDecimal LIMIT_AMOUNT_MIN = new BigDecimal(0.0199999);
